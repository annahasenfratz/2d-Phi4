#!/usr/bin/env bash
# Ethan 7x7: full-volume L64->L128 HMC, tau=2, 51 leapfrog steps.
# Usage: bash $0 [--execute] [--background]
set -euo pipefail
ROOT="$(cd "$(dirname "$0")/../.." && pwd)"
PY="${PYTHON:-$ROOT/../../.venv/bin/python}"
CONFIG="$ROOT/perfect_blocking_upsampling/run_configs/lam1p0_hmc_L64toL128_ethan7_global_tau2_n51.json"
INPUT="$ROOT/perfect_blocking_upsampling/outputs/hmc_upscale_chain_lam1p0/L32toL64/L32toL64_ethan7_N1500_S100_global_tau2_n36_eps2over36_r1/levels/L32toL64/final_phi.npz"
RUN="$ROOT/perfect_blocking_upsampling/outputs/hmc_upscale_chain_lam1p0/L64toL128/L64toL128_ethan7_N1500_S100_global_tau2_n51_eps2over51_r2"
...
printf 'run_dir=%s\ninput_L64=%s\nflow=Ethan 7x7; HMC=global full volume, 100 sweeps, tau=2, n=51, eps=2/51\n' "$RUN" "$INPUT"
[[ "$EXECUTE" -eq 1 ]] || exit 0
