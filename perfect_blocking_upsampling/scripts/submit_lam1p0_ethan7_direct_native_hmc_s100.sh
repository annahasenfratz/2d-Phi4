#!/usr/bin/env bash
# Matched HMC test for Ethan's freshly trained 7x7 direct-native L16->L32 flow.
# This matches the highcorr-5x5 test: N=5000, full-field HMC, tau=2, sweeps 0--100.
...
SEED="${SEED:-2026081816}"
INPUT="$ROOT/perfect_blocking_upsampling/outputs/flow_input_audit_lam1p0/ethan7_fresh_pureNLL_direct_native_L16_N5000_20260818/sweep0_flow_phi.npz"
RUN="$ROOT/perfect_blocking_upsampling/outputs/fine_hmc_lam1p0/global/L16toL32_ethan7_fresh_pureNLL_directnative_N${N_CHAINS}_S${N_SWEEPS}_tau2_n28_eps2over28_20260818"
