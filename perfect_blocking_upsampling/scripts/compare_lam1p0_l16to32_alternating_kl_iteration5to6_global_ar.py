#!/usr/bin/env python3
"""Common N=5000 global-A/R audit for L16->L32 alternating-KL iterations 5/6."""
...
RUN6 = PKG / "runs/lam1p0/training/lam1p0_L16to32_alternatingKL_highcorr5_r1_iteration6/flow6"
K6 = ROOT / "perfect_blocking/perfect_blocking_lam1p0/kernels/candidates/alternatingKL_L16to32_highcorr5_r1_iteration6/iteration6.json"
...
def main() -> None:
    ...
    pairs = [
        ...
        ("iteration6", RUN6 / "stage_oo/checkpoints/checkpoint_best_nll.pt", K6),
    ]
    rows = []
