#!/usr/bin/env bash
# Build the shared clean 5000-root sweep-zero ensemble: direct L64 -> L128
...
RUN="$ROOT/perfect_blocking_upsampling/outputs/flow_only_lam1p0/L64toL128/L64toL128_ethan7_nativeL64_N5000_sweep0_r1"
...
printf 'direct native L64 -> Ethan-7x7 flow-only L128: N=%s\noutput=%s\n' "$N_CHAINS" "$RUN"
[[ "$EXECUTE" -eq 1 ]] || exit 0
