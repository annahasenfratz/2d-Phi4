#!/usr/bin/env bash
# L128->L256 repeat: eps=0.06, n_leapfrog=10, streamed 25-chain batches.
...
CONFIG="$ROOT/perfect_blocking_upsampling/run_configs/lam1p0_hmc_upscale_chain_L128toL256_d2_eps0p06_streamed.json"
INPUT_L128="$ROOT/perfect_blocking_upsampling/outputs/hmc_upscale_chain_lam1p0/L8toL128/L8toL128_N1500_start0_HMCtherm100_100_100_100_d2_r3/final_phi.npz"
RUN="$ROOT/perfect_blocking_upsampling/outputs/hmc_upscale_chain_lam1p0/L8toL256/L8toL256_N${N_CHAINS}_start${START_INDEX}_HMCtherm100_100_100_100_100_d2_eps0p06_${RUN_NUMBER}"
...
[[ $EXEC -eq 1 ]] || exit 0
[[ -f "$INPUT_L128" ]] || { echo "missing completed L128 r3 field: $INPUT_L128" >&2; exit 1; }
