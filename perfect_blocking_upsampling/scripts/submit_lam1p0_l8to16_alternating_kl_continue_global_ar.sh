...
OUT="${OUT:-$ROOT/perfect_blocking_upsampling/outputs/global_ar_lam1p0/L8to16_alternatingKL_5x5_r1_iterations2to4}"
...
CMD=("$PY" -B "$ROOT/perfect_blocking_upsampling/scripts/compare_lam1p0_l8to16_alternating_kl_continue_global_ar.py" --out "$OUT" --n "$N")
