#!/usr/bin/env bash
# Same clean direct-native-L32 Ethan-7x7 sweep zero as the neighbouring-kappa
# tests, rethermalized at kappa_f=0.340340.
...
KAPPA_C=0.340301; KAPPA_F=0.340340
...
RUN="$ROOT/perfect_blocking_upsampling/outputs/fine_hmc_lam1p0/global/L32toL64_ethan7_nativeL32_sweep0_kf0p34034_N${N_CHAINS}_S${N_SWEEPS}_tau2_n36_eps2over36_r1"
