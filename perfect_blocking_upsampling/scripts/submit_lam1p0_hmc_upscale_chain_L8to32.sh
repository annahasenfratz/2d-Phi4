#!/usr/bin/env bash
# L8 -> L16 (50 HMC sweeps) -> L32 (400 HMC sweeps), fixed iteration-5 pair.
...
CONFIG="${CONFIG:-$ROOT/perfect_blocking_upsampling/run_configs/lam1p0_hmc_upscale_chain_L8to32.json}"
N_CHAINS="${N_CHAINS:-1500}"; START_INDEX="${START_INDEX:-0}"
RUN="$ROOT/perfect_blocking_upsampling/outputs/hmc_upscale_chain_lam1p0/L8toL32/L8toL32_N${N_CHAINS}_start${START_INDEX}_HMCtherm50_400_${RUN_NUMBER}"
