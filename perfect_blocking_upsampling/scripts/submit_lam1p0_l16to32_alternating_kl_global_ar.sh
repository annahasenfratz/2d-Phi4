...
OUT="${OUT:-$ROOT/perfect_blocking_upsampling/outputs/global_ar_lam1p0/L16to32_alternatingKL_highcorr5_r1}"
...
CMD=("$PY" -B "$ROOT/perfect_blocking_upsampling/scripts/compare_lam1p0_l16to32_alternating_kl_global_ar.py" --out "$OUT" --n "$N")
