#!/usr/bin/env python3
"""Final confirmation for the lambda=1.0 phi2+phi4 constrained 7x7 candidate."""
...
OUT = LAM_ROOT / "tests/final/final_kernel_confirmation_phi2_phi4_7x7"
...
KERNELS = {
    ...
    "candidate_phi2_phi4_7x7": LAM_ROOT / "kernels/candidates/7x7_full_retraining_phi2_phi4_constrained/best_7x7_full_retraining_controlled_eta_included.json",
}
...
def main() -> int:
    ...
    candidate = "candidate_phi2_phi4_7x7"
    decision_checks = {
        "phi2_improves_vs_current_final": val(candidate, "phi2", "ks_statistic") < val(current, "phi2", "ks_statistic"),
        "phi4_within_guardrail": val(candidate, "phi4", "ks_statistic") <= min(0.018, val(current, "phi4", "ks_statistic") + 0.004),
        ...
        "NN_within_guardrail": val(candidate, "NN", "ks_statistic") <= 0.035,
    ...
    lines = [
        "# Final Confirmation: Lambda 1.0 Phi2+Phi4-Constrained 7x7 Candidate",
        "",
        "Compared current final NN-constrained 7x7, retrained 5x5, and the phi2+phi4-constrained 7x7 candidate on identical L16/L32 ensembles.",
        "",
        "## Full-Sample Metrics",
        "",
    ...
    lines.extend(
        [
            ...
            "2. Copy `perfect_blocking/perfect_blocking_lam1p0/kernels/candidates/7x7_full_retraining_phi2_phi4_constrained/best_7x7_full_retraining_controlled_eta_included.json` to `kernels/final/chosen_kernel.json`.",
