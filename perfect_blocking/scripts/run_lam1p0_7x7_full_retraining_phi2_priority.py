#!/usr/bin/env python3
"""Controlled lambda=1.0 7x7 retraining with phi2 priority."""
...
OUT = LAM_ROOT / "tests/intermediate/7x7_full_retraining_phi2_priority"
CAND_DIR = LAM_ROOT / "kernels/candidates/7x7_full_retraining_phi2_priority"
...
def main() -> int:
    ...
    if best is not None:
        ...
        cand = make_candidate(
            ...
            "selection": "best staged controlled from-scratch 7x7 candidate with phi2 prioritized and phi4/NN/action guardrails",
