#!/usr/bin/env python3
"""Regression check for the lambda=1.0 eta-included final kernel convention."""
...
DEFAULT_CONFIGS = PROJECT_ROOT / "data/configs_phi4_2d/lam1p0_kappac0p340301_L32/configs.npz"
DEFAULT_OUT_ROOT = PROJECT_ROOT / "perfect_blocking/perfect_blocking_lam1p0/debug"
ETA = 0.25
...
def main() -> int:
    ...
    no_double_eta = kernel.kernel_coefficients_include_eta_scale and math.isclose(
        kernel_sum, ETA_SCALE, rel_tol=1.0e-12, abs_tol=1.0e-12
    )
    checks.append(
        {
    ...
    lines = [
        "# Lambda 1.0 eta convention regression",
        "",
